 ...
 *   - M4 user flash       : 188 KB @ 0x0800_0000 .. 0x0802_EFFF  (app image)
 *   - Setup flag page     :   4 KB @ 0x0802_F000 .. 0x0802_FFFF  (first-boot persistence)
...
MEMORY
{
    FLASH      (rx)  : ORIGIN = 0x08000000, LENGTH = 188K
